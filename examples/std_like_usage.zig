...
fn json_handler() callconv(.C) ?*anyopaque {
...
fn users_handler() callconv(.C) ?*anyopaque {
...
fn create_user_handler() callconv(.C) ?*anyopaque {
...
test "dia framework std-like API" {
    ...
    _ = @import("dia").request;
    _ = @import("dia").response;
    _ = @import("dia").controller;
    _ = @import("dia").middleware;
