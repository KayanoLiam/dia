...
extern "C" fn dia_middleware_new() ?*opaque;
extern "C" fn dia_middleware_cors(mw: ?*opaque) c_int;
extern "C" fn dia_middleware_logger(mw: ?*opaque) c_int;
extern "C" fn dia_middleware_custom(mw: ?*opaque, handler: MiddlewareHandler) c_int;
extern "C" fn dia_middleware_free(mw: ?*opaque) void;
...
pub fn authMiddleware(comptime auth_fn: fn(*Request) bool) MiddlewareHandler {
    const AuthWrapper = struct {
        fn handler(req: ?*opaque, resp: ?*opaque) callconv(.C) c_int {
